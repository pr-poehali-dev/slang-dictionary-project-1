  ...
  return (
    <div className="min-h-screen bg-muted">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <Link to="/" className="inline-flex items-center gap-2 text-gray-600 hover:text-primary">
            <Icon name="ArrowLeft" className="h-4 w-4" />
            <span>Назад к профессиям</span>
          </Link>
        </div>
        ...
        <section className="mx-auto max-w-4xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">{profession.title}</h1>
